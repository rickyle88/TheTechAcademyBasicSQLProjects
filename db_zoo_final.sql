...
--2) Run this will create a Stored Procedure in db -> Programmability - > Stored Procedures
--

--3) Right click this Stored Procedure => Execute Stored Procedure OR Create new query and Drag/Drop this file 
--USE db_zooTest2 GO   => (EXEC [dbo].[createZooDB]) )
